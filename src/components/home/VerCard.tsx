...
const VerCard = () => {
  ...
  return (
    <div className="flex flex-col items-stretch gap-2">
      <h4 className="text-lg sm:text-xl font-bold lowercase text-center">{lang === "en" ? "life - revive" : "sống - hồi sinh"}</h4>
      <img src={picture} alt="" className="w-full h-auto object-cover" />
      <p className="block text-xs sm:text-sm font-light text-justify">

    ...
    <div className="flex flex-col lg:flex-row justify-between items-stretch gap-4">
      <div className="flex flex-col justify-between items-stretch basis-1/3">
        <div className="object-cover mb-2 w-full">
          <img src={about_pic1} alt="" className="w-full h-auto object-cover" />
        </div>
        <h4 className="text-lg sm:text-xl lowercase font-bold">
          {lang === "vn"
            ? "mang theo bản sắc, không phải lớp vỏ"
            : "carry identity, not shell"}
        </h4>
        <p className="text-xs sm:text-sm font-light text-justify mt-2 lowercase">
          {lang === "vn"
      ...
      <div className="flex flex-col justify-around items-stretch basis-2/3">
        <h3 className="text-xl sm:text-2xl font-bold mb-2 lowercase">
          {lang === "vn"
        ...
        <div className="object-cover flex-1 w-full mt-2">
          <img src={about_pic2} alt="" className="w-full h-auto object-cover" />
        </div>
      </div>
    </div>
  );
